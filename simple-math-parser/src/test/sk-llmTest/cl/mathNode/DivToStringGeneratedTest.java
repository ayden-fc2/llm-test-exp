...
public class DivToStringGeneratedTest {
    ...
    @Test
    public void test_toString_noParens_simpleNodes() {
    ...
    @Test
    public void test_toString_withParens_simpleNodes() {
        MathNode left = new MathNodeStub("5", false);
        MathNode right = new MathNodeStub("3", false);
    ...
    @Test
    public void test_toString_noParens_complexNodes() {
    ...
    @Test
    public void test_toString_withParens_complexNodes() {
        MathNode left = new MathNodeStub("(2 + 3)", true);
        MathNode right = new MathNodeStub("x", false);
        Div div = new TestableDiv(left, right, true);
    ...
    public void test_toString_edgeCases(String leftStr, String rightStr, boolean parens, String expected) {
    ...
    static Stream<Arguments> provideEdgeCases() {
        return Stream.of(
            ...
            Arguments.of("Infinity", "2", false, "Infinity / 2"),
            Arguments.of("-Infinity", "2", false, "-Infinity / 2"),
            Arguments.of("NaN", "2", false, "NaN / 2"),
    ...
    @Test
    public void test_toString_withParens_emptyStrings() {
        MathNode left = new MathNodeStub("", false);
        MathNode right = new MathNodeStub("", false);
        Div div = new TestableDiv(left, right, true);
